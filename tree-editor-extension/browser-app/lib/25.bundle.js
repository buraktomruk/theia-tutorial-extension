...
/***/ "../tree-editor-extension/lib/browser/tree/Rating.js":
/*!***********************************************************!*\
  !*** ../tree-editor-extension/lib/browser/tree/Rating.js ***!
  \***********************************************************/
/*! no static exports found */
...
var Rating = function (_a) {
    var id = _a.id, value = _a.value, updateValue = _a.updateValue;
    var _b = __read(react_1.useState(null), 2), hoverAt = _b[0], setHoverAt = _b[1];
    return (React.createElement("div", { id: "#/properties/rating", className: "rating" },
        React.createElement("p", null, "Rating:"),
        React.createElement("span", { style: { cursor: "pointer" } }, [0, 1, 2, 3, 4].map(function (i) {
            var fullStars = hoverAt !== null && hoverAt !== void 0 ? hoverAt : value;
            return (React.createElement("span", { onMouseOver: function () { return setHoverAt(i + 1); }, onMouseOut: function () { return setHoverAt(null); }, onClick: function () { return updateValue(i + 1); }, key: id + "_" + i }, i < fullStars ? "\u2605" : "\u2606"));
        }))));
};
...
/***/ "../tree-editor-extension/lib/browser/tree/RatingControl.js":
/*!******************************************************************!*\
  !*** ../tree-editor-extension/lib/browser/tree/RatingControl.js ***!
  \******************************************************************/
/*! no static exports found */
...
var Rating_1 = __webpack_require__(/*! ./Rating */ "../tree-editor-extension/lib/browser/tree/Rating.js");
var RatingControl = function (_a) {
    var data = _a.data, handleChange = _a.handleChange, path = _a.path;
    return (React.createElement(Rating_1.Rating, { value: data, updateValue: function (ev) { return handleChange(path, Number(ev.value)); } }));
};
exports.default = react_1.withJsonFormsControlProps(RatingControl);
...
/***/ "../tree-editor-extension/lib/browser/tree/ratingControlTester.js":
/*!************************************************************************!*\
  !*** ../tree-editor-extension/lib/browser/tree/ratingControlTester.js ***!
  \************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(/*! @jsonforms/core */ "../node_modules/@jsonforms/core/lib/index.js");
exports.default = core_1.rankWith(3, //increase rank as needed
core_1.scopeEndsWith('rating'));
...
var RatingControl_1 = __webpack_require__(/*! ./RatingControl */ "../tree-editor-extension/lib/browser/tree/RatingControl.js");
var ratingControlTester_1 = __webpack_require__(/*! ./ratingControlTester */ "../tree-editor-extension/lib/browser/tree/ratingControlTester.js");
...
var TutorialDetailFormWidget = /** @class */ (function (_super) {
    ...
    TutorialDetailFormWidget.prototype.customizeRenderers = function () {
        var renderers = __spread(material_renderers_1.materialRenderers, [
            ...
            // },
            { tester: ratingControlTester_1.default, renderer: RatingControl_1.default },
